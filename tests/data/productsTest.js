...
describe('test suite: Product', () => {
  ...
  it('has the correct properties', () => {
    ...
    expect(product.pricePaise).toEqual(96618);
  });
  ...
  it('gets the price', () => {
    expect(product.getPrice()).toEqual('₹966.18');
  });
...
describe('test suite: Clothing', () => {
  ...
  it('gets the price', () => {
    expect(clothing.getPrice()).toEqual('₹708.24');
  });
...
describe('test suite: Appliance', () => {
  ...
  it('gets the price', () => {
    expect(appliance.getPrice()).toEqual('₹1683.28');
  })
